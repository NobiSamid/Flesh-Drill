...
const About = () => {
    return (
        <div>
            ...
            <h1>Our Mission</h1>
            <p>Human body is a wonderfull creature of God. It has so much ability that you can't imagine.Most of us are well aware of the many health benefits of exercise, but finding the discipline to not only start training but to also stick with it is often the hard part.
             Whether you’re at the beginning of your fitness journey or in desperate need of some motivation to keep going, you’ll find it on these blogs — and in their educational, inspirational, and empowering content. Our main job is to make everyones body look and works good</p>
            </div>
            <div>
